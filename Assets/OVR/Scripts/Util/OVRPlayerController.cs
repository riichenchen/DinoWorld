...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// <summary>
	/// The character model to be animated
	/// </summary>
	...
	protected virtual void Update()
	{
		...
		if (animator != null) {
			if(animator.GetCurrentAnimatorStateInfo(0).IsName("Walk")) {
				Debug.Log (Vector3.Scale (moveDirection, new Vector3 (1, 0, 1)).magnitude + " Walk");
			} else if(animator.GetCurrentAnimatorStateInfo(0).IsName("Idle")) {
				Debug.Log (Vector3.Scale (moveDirection, new Vector3 (1, 0, 1)).magnitude + " Idle");
			}

		}

		if (animator != null) {
			animator.SetFloat (Animator.StringToHash ("Speed"), Vector3.Scale (moveDirection, new Vector3 (1, 0, 1)).magnitude);
		}
